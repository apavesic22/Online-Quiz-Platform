...
/**
 * @api {get} /api/teams Retrieving teams
 * @apiGroup Teams
 *
 ...
 * @apiQuery {Number} [limit=10] Limit of the records
  *
 * @apiSuccess {Object[]} teams Array of the teams
 * @apiSuccess {Number} teams.id Team identifier
 * @apiSuccess {String} teams.name Name of the team (short)
 * @apiSuccess {String} teams.longname Long name of the team
 * @apiSuccess {String} teams.color HTML color name used to display the team chip
 * @apiSuccess {Number} teams.has_avatar 1 if the team has avatar, 0 otherwise
 * @apiSuccess {Number} teams.member_count Number of the team members
 * @apiUse HttpError
*/
...
/**
 * @api {post} /api/teams Adding new team
 * @apiGroup Teams
 *
 * @apiBody {String} name Name of the team
 * @apiBody {String} longname Long name of the team
 * @apiBody {String} color HTML color name used to display the team chip
 * @apiBody {Number} has_avatar 1 if the team has avatar, 0 otherwise
 *
 * @apiSuccess {Number} id Id of the just added team (automatically generated)
 * @apiSuccess {String} name Name of the team
 * @apiSuccess {String} longname Long name
 * @apiSuccess {String} color HTML color name used to display the team chip
 * @apiSuccess {Number} has_avatar 1 if the team has avatar, 0 otherwise
 * @apiUse HttpError
*/
...
/**
 * @api {put} /api/teams Modyfing existing team
 * @apiGroup Teams
 *
 * @apiBody {Number} id Id of the team to modify
 * @apiBody {String} name Name of the team
 * @apiBody {String} longname Long name of the team
 * @apiBody {String} color HTML color name used to display the team chip
 * @apiBody {Number} has_avatar 1 if the team has avatar, 0 otherwise
 *
 * @apiSuccess {Number} id Id of the just modified team
 * @apiSuccess {String} name Name of the team
 * @apiSuccess {String} longname Long name
 * @apiSuccess {String} color HTML color name used to display the team chip
 * @apiSuccess {Number} has_avatar 1 if the team has avatar, 0 otherwise
...
/**
 * @api {delete} /api/teams Deleting existing team
 * @apiGroup Teams
 *
 * @apiQuery {Number} id Id of the team to delete
 *
 * @apiSuccess {Number} id Id of the just deleted team
 * @apiSuccess {String} name Its name
 * @apiSuccess {String} longname Long name
 * @apiSuccess {String} color Color
 * @apiSuccess {Number} has_avatar If the team had an avatar
 * @apiUse HttpError
*/
